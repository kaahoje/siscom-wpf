...
{
   public  class ParceiroNegocioPessoaFisicaFormModel : ModelFormGeneric<Business.Entity.Contabil.Pessoa.SubClass.PessoaFisica.SubClass.ParceiroNegocio.ParceiroNegocioPessoaFisica>,IPessoa
   {
       ...
       public override void Excluir()
       {
           try
           {
               if (ConfirmDelete())
               {
                   ...
                   ParceiroNegocioPessoaFisicaRepository.Save(Entity);
                   Entity = new Business.Entity.Contabil.Pessoa.SubClass.PessoaFisica.SubClass.ParceiroNegocio.ParceiroNegocioPessoaFisica();
                   base.Excluir();
               }
           }
