...
{
    public class ParceiroNegocioPessoaJuridicaFormModel : ModelFormGeneric<Business.Entity.Contabil.Pessoa.SubClass.PessoaJuridica.SubClass.ParceiroNegocio.ParceiroNegocioPessoaJuridica>, IPessoa
    {
        ...
        public override void Excluir()
        {
            try
            {
                if (ConfirmDelete())
                {
                    ...
                    ParceiroNegocioPessoaJuridicaRepository.Save(Entity);
                    Entity = new Business.Entity.Contabil.Pessoa.SubClass.PessoaJuridica.SubClass.ParceiroNegocio.ParceiroNegocioPessoaJuridica();
                    base.Excluir();
                }
            }
